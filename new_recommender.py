...
# movies_df.csv
url = "https://drive.google.com/file/d/1RgmkDTF-qOsqRpFlbHhFKLnW-8PYUMPU/view?usp=sharing"
path = "https://drive.google.com/uc?export=download&id=" + url.split("/")[-2]
movies_df = pd.read_csv(path)

# ratings_df.csv
url = "https://drive.google.com/file/d/1Fj8A8BJMPQA5b0X4MK94L9KEQTpn-gj3/view?usp=sharing"
path = "https://drive.google.com/uc?export=download&id=" + url.split("/")[-2]
